...
export default function ACServicePage() {
  ...
  const acBrands = [
    { name: "LG", basePrice: 35000, image: null },
    { name: "Daikin", basePrice: 42000, image: null },
    { name: "Samsung", basePrice: 38000, image: null },
    { name: "Blue Star", basePrice: 40000, image: null },
    { name: "Voltas", basePrice: 32000, image: null },
    { name: "Haier", basePrice: 34000, image: null },
    { name: "Panasonic", basePrice: 39000, image: null },
    { name: "Godrej", basePrice: 31000, image: null }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
                Professional <span className="text-blue-300">Air Conditioning</span> Services
              </h1>
              <p className="text-xl mb-8 text-blue-100 leading-relaxed">
                Complete AC maintenance, repair and installation services for residential and commercial units. 
                Keep your space cool and comfortable year-round with our expert technicians.
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8 hover:shadow-3xl transition-all duration-500 border border-gray-100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                {/* Gas Refill - Special Card */}
                <div className="sm:col-span-2">
                  <div className="relative bg-gradient-to-r from-orange-50 to-red-50 p-4 rounded-xl border-2 border-orange-400 hover:shadow-lg transition-all duration-300 transform hover:scale-102">
                    ...
                    <div className="text-center">
                      ...
                      <h3 className="font-bold text-gray-800 text-sm mb-2">Gas refill & check-up</h3>
                      <div className="flex items-center justify-center mb-1">
                        <Star className="w-3 h-3 text-yellow-500 fill-current mr-1" />
                        <span className="text-xs text-gray-600">4.92 (45K)</span>
                      </div>
                      <p className="text-xs text-gray-500 mb-3">2-4 hrs</p>
                      <div className="text-xl font-bold text-orange-600 mb-3">₹2700</div>
                      <button className="bg-gradient-to-r from-orange-500 to-red-500 text-white px-4 py-2 rounded-lg font-semibold hover:from-orange-600 hover:to-red-600 transition-all duration-300 transform hover:scale-105 shadow-md w-full text-sm">
                        Book Now
                      </button>
                    </div>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl mb-8 text-blue-100">Contact us today for professional, reliable AC services</p>
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="bg-white bg-opacity-10 backdrop-blur-sm p-8 rounded-xl border border-white border-opacity-20">
                ...
                <h3 className="text-2xl text-blue-300 font-bold mb-2">Call Now</h3>
                <p className="text-blue-300  mb-4">Speak directly with our experts</p>
              ...
              <div className="bg-white bg-opacity-10 backdrop-blur-sm p-8 rounded-xl border border-white border-opacity-20">
                ...
                <h3 className="text-2xl text-blue-300 font-bold mb-2">Book Online</h3>
                <p className="text-blue-300 mb-4">Schedule at your convenience</p>
                <button className="border-2 border-white text-blue-300 px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition-all duration-300 transform hover:scale-105 w-full">
                  Schedule Now
                </button>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <div className="flex items-center space-x-3">
              <span className="text-xl font-bold">AC Services</span>
            </div>
          ...
          <div className="border-t border-gray-800 mt-6 pt-6 text-center text-sm text-gray-400">
            <p>&copy; 2025 CoolTech Services. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
